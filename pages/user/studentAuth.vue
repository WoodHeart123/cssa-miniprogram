<template>
    <view id="studentAuth">
        ...
        <button class="confirm-button" style="background-color: #9b0000; color: #ffffff" v-show="showButton" @click="confirm">
            确定
        </button>
    </view>
</template>
...
export default {
    ...
    methods: {
        ...
        async confirm() {
            ...
            const opts = {
                path: '/user/verifyAuthCode?authCode=' + encodeURI(this.authCode),
                type: 'GET',
            };
            requestAPI(opts)
                .then((response) => {
        ...
        async getAuthCode() {
            ...
            if (this.regex.test(this.email)) {
                ...
                const opts = {
                    path: '/user/getAuthCode?email=' + encodeURI(this.email),
                    type: 'GET',
                };
