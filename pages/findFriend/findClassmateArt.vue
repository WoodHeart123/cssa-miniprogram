<template>
    <view class="find-classmate-art-background">
        ...
        <div class="art-news-board">
            <div class="news">
                <div v-for="(post, index) in posts" style="width: 90%">
                    <navigator
                        v-bind:url="'./singlePostDetail?post=' + encodeURIComponent(JSON.stringify(post))"
                        style="width: 100%"
                    >
                        <singlePost
