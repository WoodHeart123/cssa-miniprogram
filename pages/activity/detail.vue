    ...
    <view class="act-detail">
        ...
        <view class="content-box">
            ...
            <view class="lower-box">
                <view class="price">
                    <text v-if="this.actDetail.price != 0" class="dollar-sign">$</text
                    ><text v-if="this.actDetail.price != 0" class="new-price">{{ actDetail.price }}</text>
...
export default {
    ...
    computed: {
        ...
        actDateDurationFormat() {
            return (
                moment(this.actDetail.startDate).format('MM-DD ') +
                this.weekday[moment(this.actDetail.startDate).isoWeekday()] +
                moment(this.actDetail.startDate).format(' HH:mm - ') +
                moment(this.actDetail.endDate).format('HH:mm')
            );
        },
        startDateWeekDay() {
