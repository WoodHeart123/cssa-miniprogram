<template>
    <scroll-view id="post-comment" :scroll-y="true">
        <view class="comment-form">
            ...
            <button class="button" style="background-color: #9b0000; color: #ffffff" type="default" @click="submit">
                提交
            </button>
        </view>
    </scroll-view>
    ...
    methods: {
        ...
        async postComment() {
            ...
            if (res.data.status == 500) {
                ...
                uni.setStorageSync('commentMap', this.commentMap);
                this.course.avgPrefer =
                    (this.course.avgPrefer * this.course.commentCount + this.comment.prefer) / (this.course.commentCount + 1);
                this.course.avgDifficulty =
                    (this.course.avgDifficulty * this.course.commentCount + this.comment.difficulty) /
