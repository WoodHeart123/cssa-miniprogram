<template>
    <view>
        <view class="column-container course-box">
            <view class="course-name-box">
                <view class="course-name"
                    ><Text>{{ course.courseName }}</Text></view
                >
            </view>
            <view class="row-container course-intro-box">
                <view class="course-diff-like">
                    <view class="row-container rate-box">
                        ...
                        <view class="rate-num"
                            ><text>{{ course.avgDifficulty.toFixed(1) }}</text></view
                        >
                    </view>
                    <view class="row-container rate-box">
                        ...
                        <view class="rate-num"
                            ><text>{{ course.avgPrefer.toFixed(1) }}</text></view
                        >
                    </view>
                </view>
        ...
        <view
            ...
            class="column-container comment-container"
            @scrolltolower="getCommentList()"
        >
...
export default {
    ...
    methods: {
        ...
        async getCommentList() {
            ...
            const opts = {
                path:
                    '/course/getCommentList?courseID=' +
