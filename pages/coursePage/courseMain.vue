<template>
    <view>
        <view class="column-container suggest-list" v-if="searching">
            ...
            <view
                class="row-container suggest-box"
                v-for="(course, index) in suggestList"
                :key="index"
        ...
        <uni-transition ref="main" show customClass="full-screen">
            <view id="course" class="row-container" @touchstart="touchstart" @touchmove="touchmove">
                ...
                <scroll-view
                    ...
                    @refresherabort="refreshRestore"
                    @scrolltolower="onScrollLower"
                >
                    <view class="row-container filter-box">
                        <view
                            :class="key == 0 ? 'filter-selected filter' : 'filter'"
                            class="row-container"
                            @click="changeKey(0)"
                        >
                            <text>课号</text>
                        ...
                        <view
                            :class="key == 1 ? 'filter-selected filter' : 'filter'"
                            class="row-container"
                            @click="changeKey(1)"
                        >
                            <text>热门课程</text>
                        ...
                        <view
                            :class="key == 4 ? 'filter-selected filter' : 'filter'"
                            class="row-container"
                            @click="changeKey(4)"
                        >
                            <text>推荐</text>
                        ...
                        <view
                            :class="key == 2 ? 'filter-selected filter' : 'filter'"
                            class="row-container"
                            @click="changeKey(2)"
                        >
                            <text>难度</text>
                        ...
                        <view
                            :class="!isGrad ? 'filter-selected filter' : 'filter'"
                            class="row-container"
