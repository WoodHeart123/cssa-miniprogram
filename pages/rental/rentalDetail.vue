    ...
    <view class="house-detail">
        ...
        <view class="basic">
            ...
            <view class="row-container" style="margin-top: 5px; margin-left: 4px">
                ...
                <view class="price"
                    ><text>{{ houseInfo.price }}/m</text></view
                >
            </view>
            <view class="house-name"
                ><text>{{ houseInfo.location }}</text></view
            >
        </view>
        <view class="row-container">
            <view class="info-box"
                ><text>{{ sexContraintValue[this.houseInfo.sexConstraint] }}</text></view
            >
            <view class="info-box"
                ><text>{{ houseInfo.floorPlan }}</text></view
            >
        </view>
        <view class="contact">
...
export default {
    ...
    computed: {
        rentalTime() {
            return (
                moment(this.houseInfo.rentalStartTime).format('YYYY-MM-DD') +
                ' 至 ' +
                moment(this.houseInfo.rentalEndTime).format('YYYY-MM-DD')
            );
        },
    },
};
