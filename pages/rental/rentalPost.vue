            ...
            <view class="card label_group">
                <uni-forms-item name="sexConstraint">
                    <uni-data-checkbox
                        ...
                        v-model="rental.sexConstraint"
                        :localdata="sexConstraint"
                    ></uni-data-checkbox>
                </uni-forms-item>
            </view>
            ...
            <view class="card">
                <uni-forms-item name="contact">
                    <view class="uni-column row-view">
                        ...
                        <input
                            class="uni-input"
                            v-model="rental.contact"
                            maxlength="22"
                            placeholder="请填写微信号以便联系"
                            placeholder-style="font-size:14px;color:gray"
                        />
                    </view>
...
export default {
    ...
    onLoad(options) {
        ...
        if (options.rental != null) {
            ...
            this.rental.time = [
                moment(this.rental.rentalStartTime).format('YYYY-MM-DD'),
                moment(this.rental.rentalEndTime).format('YYYY-MM-DD'),
            ];
        }
    },
    onShow() {
