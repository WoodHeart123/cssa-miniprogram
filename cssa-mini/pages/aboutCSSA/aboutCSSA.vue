<template>
	<view class="about-page">
		<swiper class="swiper" circular :autoplay="autoplay" :interval="interval"
			:duration="duration">
			<swiper-item>
				<image class="image" src="https://cssa-mini-na.oss-us-west-1.aliyuncs.com/cssa-main/2020members.jpg"></image>
			</swiper-item>
			<swiper-item>
				<image class="image" src="https://cssa-mini-na.oss-us-west-1.aliyuncs.com/cssa-main/yanhua.jpg"></image>
			</swiper-item>
			<swiper-item>
		...
		<view>
			...
			<view id="demo2" class="scroll-view-item uni-bg-green">
				...
				<image mode="aspectFit" class="zhuxituan" src="https://cssa-mini-na.oss-us-west-1.aliyuncs.com/cssa-main/zhuxituan.png"></image>
				<view class="name">
...
<style lang="scss">
	...
	.app_content_medium {
		...
		font-size: 50rpx;
		font-weight: 250;
		background-image: url("https://cssa-mini-na.oss-us-west-1.aliyuncs.com/cssa-main/bg.png");
	}
	.app_content_1 {
		padding-top: 0rpx;
		text-align: center;
