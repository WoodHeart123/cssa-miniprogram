<template>
	<view class="rest-box">
		<view class="row-container course-title" v-if="user">
			<text class="course-name">{{comment.restName}}</text>
		</view>
		<view class="comment-head-area row-container">
			...
			<view class="user-rate-box">
				<view class="row-container rate-sub-box">
					<view><text class="user-rate-text">好吃:</text></view>
					<uni-rate readonly="true" :value="comment.good" allowHalf="true" size="17"></uni-rate>
					<view><text class="user-rate-text">{{comment.good}}</text></view>
				</view>
				<view class="row-container rate-sub-box">
