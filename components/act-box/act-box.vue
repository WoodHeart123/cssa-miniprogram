            ...
            <div class="lower-box">
                <div class="content-box">
                    ...
                    <div class="row">
                        ...
                        <text class="font-small paragraph-1" style="white-space: nowrap; overflow: hidden">{{
                            this.actDetail.location
                        }}</text>
                    </div>
                </div>
                <div class="button-box">
                    <view class="button" :class="{ disabled: ifJoined }"
                        ><text class="button-text">{{ ifJoined ? '已报名' : '报名' }}</text></view
                    >
                </div>
            </div>
        </div>
...
export default {
    ...
    computed: {
        actDateFormat() {
            return (
                moment(this.actDetail.startDate).locale('zh-cn').format('MM.DD/ddd H:mm - ') +
