<template>
    <view id="main-advertisement">
        <uni-swiper-dot class="uni-swiper-dot-box" v-bind:info="images" :current="current" mode="dot" field="content">
...
export default {
    ...
    data() {
        return {
            images: ['https://cssa-mini-na.oss-us-west-1.aliyuncs.com/cssa-main/cssa3.png'],
            detailImages: ['https://cssa-mini-na.oss-us-west-1.aliyuncs.com/cssa-main/cssa1-detail.jpg'],
            current: 0,
        };
    },
    onLoad() {
